...
COVERED_PACKAGES ?= internal/controller/packagesource internal/controller/pkg internal/controller/platform internal/crd internal/flux internal/kube pkg/wait
COVERAGE_MIN ?= 95
